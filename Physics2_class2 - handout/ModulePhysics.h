...
public:
	...
	void CreateCircle(float new_radius);
	void CreateBox(float width, float heigth);
	void CreateLoopChain(int* points, uint size);
	void CreateLoopChain(float* points, uint size);
